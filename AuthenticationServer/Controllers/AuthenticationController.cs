...
using AuthenticationServer.Services.PasswordHashers;
using AuthenticationServer.Services.TokenGenerators;
using AuthenticationServer.Services.UserRepositories;
...
namespace AuthenticationServer.Controllers
{
    public class AuthenticationController:Controller
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequest registerRequest)
        {
            ...
            string passwordHesh = _passwordHasher.HashPassword(registerRequest.Password);
